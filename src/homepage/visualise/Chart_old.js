...
import Tooltip from './main-chart/components/Tooltip';
import ChartButtons from './main-chart/components/ControlsButton';
...
export default class Chart_old extends React.Component<ChartProps, ChartStates> {
    // React refs
    chartNodeRef: any;
    pannableNodeRef: any;
     ...
     * is provided. This is done via changing the "key" prop up in <Visualize />.
     * */
        ...
        return (
            <div className="chart-container">
                ...
                <Tooltip show={tooltip.show}
                         ...
                         pos={tooltip.pos}
                         color={tooltip.color} />
                <ChartButtons action={this.resetChartPosition} />
                {children}
